...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="flex flex-col lg:flex-row bg-white text-black">
      {/* Left Section */}
      <div className="flex-1 p-4 md:p-6 lg:p-8">
        <div className="flex flex-col gap-3 md:gap-4 lg:ml-auto text-left w-fit">
          ...
          <div className="pt-2">
            <p className="text-gray-600 font-semibold text-sm md:text-base">{site?.email || "..."}</p>
            <div className="flex gap-2 md:gap-3 mt-2 text-gray-500">
